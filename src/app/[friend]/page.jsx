      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-8 flex flex-col gap-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div
             className="bg-white rounded-xl shadow-sm border border-gray-100 py-6 flex flex-col items-center justify-center text-center">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                <img src="/call.png" alt="Call" className="w-5 h-5 opacity-70" />
              ...
              <button
                ...
                className="py-4 bg-[#F8F9FA] border border-gray-100 rounded-lg flex flex-col items-center justify-center gap-2 hover:bg-gray-100 transition-colors text-gray-700"
              >
                <img src="/text.png" alt="Text" className="w-5 h-5 opacity-70" />
              ...
              <button
                ...
                className="py-4 bg-[#F8F9FA] border border-gray-100 rounded-lg flex flex-col items-center justify-center gap-2 hover:bg-gray-100 transition-colors text-gray-700"
              >
                <img src="/video.png" alt="Video" className="w-5 h-5 opacity-70" />
