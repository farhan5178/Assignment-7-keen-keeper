...
export default function FriendCard({ friend }) {
  const { name, picture, tags, days_since_contact, status } = friend;

  return (
    <div className="p-6 bg-white rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center gap-2">
      <img 
        src={picture} 
        alt={name} 
